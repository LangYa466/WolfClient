...
import cn.langya.util.impl.misc.StringUtils;
...
//            s = EnumChatFormatting.getTextWithoutFormattingCodes(s);
    ...
    private int getTextureId(DynamicTexture texture) {
        int glTextureId = -1;
        try {
            Field f = DynamicTexture.class.getDeclaredField("glTextureId");
            f.setAccessible(true);
            glTextureId = f.getInt(texture);
