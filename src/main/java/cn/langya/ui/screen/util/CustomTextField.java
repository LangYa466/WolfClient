...
public class CustomTextField extends Gui {
    ...
    public CustomTextField(int componentId, FontDrawer fontrendererObj, int x, int y, int par5Width, int par6Height) {
        this.id = componentId;
    ...
    public void drawTextBox() {
        if (this.getVisible()) {
            if (this.getEnableBackgroundDrawing()) {
                RenderUtil.drawRoundedRect(this.xPosition - 1, this.yPosition - 1, this.width, this.height, 3, 0xffffffff, 1.5f, this.isFocused ? 0xff7d7d7d : this.getText().isEmpty() ? 0xffdbdbdb : 0xff7d7d7d);
            }
            ...
            int l = this.enableBackgroundDrawing ? this.xPosition + 6 : this.xPosition;
            ...
            if (s.length() > 0 && flag && j < s.length()) {
                j1 = this.fontRendererInstance.drawString(s.substring(j),  j1 + 1,  i1, i);
            }
            ...
            if (flag1) {
                if (flag2) {
                    ...
                    Gui.drawRect(k1, i1 - 1, k1 + 1, i1 + this.fontRendererInstance.FONT_HEIGHT, -3092272);
                }
            }
