...
import cn.langya.util.impl.shader.BackgroundShader;
 ...
 */
    ...
    public void drawClientBackgrond() {
        RenderUtil.drawRect(0,0,sr.getScaledWidth(),sr.getScaledHeight(), new Color(0,0,0,60).getRGB());
